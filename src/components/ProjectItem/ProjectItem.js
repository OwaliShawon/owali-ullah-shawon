  ...
  return (
    <div className="links mt-2">
      <ul>
        {source && (
          <li>
            <ExternalLink className="ms-1" href={source} title={`View ${name} source`} aria-label={`View ${name} source`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="card-body d-flex flex-column">
          <div className="project-details">
            ...
            <div className="mt-auto">
              <ProjectLinks demo={projectInfo.demo} source={projectInfo.source} name={projectInfo.name} />
